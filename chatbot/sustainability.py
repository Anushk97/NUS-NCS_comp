...
class sustainability:
    def __init__(self):
        ...
        self.query1 = "SELECT * FROM `nus-competition.Chatbot.public_transport_utilization`"
        self.query2 = "SELECT * FROM `nus-competition.Chatbot.carbon_emission`"
    ...
    def plot_dataframes(self, final_year, show_legend, point_style='line'):
        ...
        #titles = ["Carbon Emissions (in millions) & Car Volume (in hundreds)", "Peak Period Public Transport Utilitzation Rate"]
